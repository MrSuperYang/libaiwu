			...
			<!--顶部信息-->			
				<div class="wwrapw">
					...
					<div class="w_delivery">
						...
						<div class="wamount">
							<!--左边-->
							<div class="wamount_left">
								<span>应付金额 : <i>165.90</i></span> <span>(在线支付)</span><br />
								<strong>支付平台</strong>
							</div>
							<!--右边-->
							<div class="wamount_right">
								<span>订单编号:123456789123</span>
							</div>
						</div>
						<!--付款方式-->
						<div class="wpayment">
...
table {
	...
	border-spacing: 0;
		...
		.ww {
			...
			.pay_in{margin-left: 38px;}
			.wpayment input:nth-child(2){
				margin-left: 38px;
			}
			.wpayment img {
